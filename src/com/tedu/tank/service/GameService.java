...
import com.tedu.tank.controller.GameControl;
import com.tedu.tank.controller.BonusControl.Bonus;
import com.tedu.tank.dto.GameDto;
import com.tedu.tank.entity.Bullet;
import com.tedu.tank.entity.Map;
import com.tedu.tank.entity.Tank;
import com.tedu.tank.factory.TankFactory;
...
public class GameService extends Observable {
	 ...
	 * @return 是否碰到障碍物
	 */
	public boolean isTankBlocked(Tank tank) {
	    Point currentPoint = tank.getPoint();
	    Point move = tank.getMove();
	    Point nextPoint = new Point(currentPoint.x + move.x, currentPoint.y + move.y);
	    return!tankMove(nextPoint);
	}
	/**
	 * 向数据层添加子弹
	 * 
